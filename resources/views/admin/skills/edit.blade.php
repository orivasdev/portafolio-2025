...
@section('page-description', 'Modifica la información de la habilidad')
        ...
        <div class="figma-card p-4 lg:p-6">
            <div class="flex items-center space-x-3 lg:space-x-4">
                <div class="w-10 h-10 lg:w-12 lg:h-12 bg-indigo-100 rounded-xl flex items-center justify-center">
                    <i data-feather="edit-2" class="h-5 w-5 lg:h-6 lg:w-6 text-indigo-600"></i>
                </div>
                <div>
                    <h2 class="text-lg lg:text-xl font-bold text-gray-900">Editar Habilidad</h2>
                    <p class="text-sm lg:text-base text-gray-600">{{ $skill->name }}</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="figma-card p-4 lg:p-6">
            ...
            <div>
                ...
                <textarea name="description" 
                          ...
                          placeholder="Describe tu experiencia con esta habilidad, proyectos donde la has usado, etc.">{{ old('description', $skill->description) }}</textarea>
